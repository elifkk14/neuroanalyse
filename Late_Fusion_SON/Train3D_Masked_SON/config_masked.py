...
MRI_DIR = PROJECT_ROOT / "masked_mri"
MRI_CENTILOIDS_CSV = PROJECT_ROOT / "masked_mri_centiloids_filtered.csv"

ANALYSIS_REPORTS_DIR = PROJECT_ROOT / "analysis_reports"

CHECKPOINT_DIR = PROJECT_ROOT / "checkpoints_masked_filtered_huber"
LOG_DIR = PROJECT_ROOT / "logs_masked_filtered_huber"
...
EXPERIMENT_CONFIG = {
    "name": "small3dresnet_masked_filtered_huber",
    "model": MODEL_CONFIG,
    "data": DATA_CONFIG,
