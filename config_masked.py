...
MRI_DIR = PROJECT_ROOT / "masked_mri"          # masked MRI klasörü
MRI_CENTILOIDS_CSV = PROJECT_ROOT / "masked_mri_centiloids.csv"   # masked CSV
...
EXPERIMENT_CONFIG = {
    "name": "small3dresnet_masked_mri_asinh_smoothl1",
    "model": MODEL_CONFIG,
    "data": DATA_CONFIG,
